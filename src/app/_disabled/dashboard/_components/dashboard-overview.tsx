...
export default function DashboardOverview() {
  ...
  const { data: recentPosts } = api.dashboard.getRecentPosts.useQuery({
    limit: 6,
  });
      ...
      >
        {[
          ...
          },
          {
            ...
            delta: `${stats?.totalProjects ? stats.totalProjects - 2 : 0} published · 2 draft`,
          },
          {
            label: "Articles",
          ...
          >
            ...
            <span
              style={{
                ...
                color: stat.flat ? "var(--dim)" : "var(--accent)",
              }}
            >
              {stat.delta}
            </span>
