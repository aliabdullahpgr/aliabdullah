...
const navSections = [
  {
    ...
    items: [
      ...
      { href: "/dashboard/site", label: "Site content", badge: "⌘2" },
    ],
  },
  {
    label: "Content",
    items: [
      { href: "/dashboard/projects", label: "Projects", badge: "11" },
      { href: "/dashboard/writing", label: "Writing", badge: "14" },
      { href: "/dashboard/chat", label: "Chat", badge: "" },
    ],
  },
  {
    label: "Account",
    items: [
      { href: "/dashboard/users", label: "Users", badge: "3" },
      { href: "/dashboard/settings", label: "Settings", badge: "" },
    ],
  },
];
