  ...
  const projects = [
    {
      ...
      stack: JSON.stringify(["Next.js", "Sanity", "TypeScript", "MDX"]),
      category: "SaaS",
      tags: JSON.stringify(["blog", "cms", "nextjs"]),
      published: true,
      order: 0,
    },
    {
      ...
      status: "In production",
      role: "Solo",
      stack: JSON.stringify(["Next.js", "Postgres", "Charts"]),
    ...
    },
    {
      ...
      status: "In production",
      role: "Full-stack lead",
      stack: JSON.stringify(["React", "Node", "MongoDB", "SQL"]),
      category: "Government",
      tags: JSON.stringify(["agriculture", "dashboard", "government"]),
      published: true,
      order: 2,
    },
    {
      ...
      status: "In production",
      role: "Full-stack",
      stack: JSON.stringify(["MERN", "Redux", "MUI v5"]),
      category: "Fintech",
      tags: JSON.stringify(["ai", "credit", "fintech"]),
      published: true,
      order: 3,
    },
    {
      ...
      status: "Prototype",
      role: "Solo",
      stack: JSON.stringify(["Python", "Gemini", "Agents"]),
      category: "AI",
      tags: JSON.stringify(["ai", "agents", "python"]),
      published: true,
      order: 4,
    },
    {
      ...
      status: "In production",
      role: "Solo",
      stack: JSON.stringify(["SvelteKit", "SQLite", "PWA"]),
      category: "Side project",
      tags: JSON.stringify(["productivity", "pwa"]),
      published: true,
      order: 5,
    },
    {
      ...
      status: "Open source",
      role: "Solo",
      stack: JSON.stringify(["Python", "CLI", "Embeddings"]),
      category: "Open source",
      tags: JSON.stringify(["cli", "python", "open-source"]),
      published: true,
      order: 6,
    },
    {
      ...
      status: "In production",
      role: "Solo",
      stack: JSON.stringify(["React Native", "Express", "SQLite"]),
      category: "Client",
      tags: JSON.stringify(["mobile", "bookkeeping"]),
      published: true,
      order: 7,
    },
    {
      ...
      status: "Hackathon",
      role: "Team",
      stack: JSON.stringify(["LangChain", "FastAPI", "Pinecone"]),
      category: "Hackathon",
      tags: JSON.stringify(["ai", "rag", "hackathon"]),
      published: true,
      order: 8,
    },
    {
      ...
      status: "Open source",
      role: "Solo",
      stack: JSON.stringify(["React", "TypeScript", "Radix"]),
      category: "Open source",
      tags: JSON.stringify(["ui", "react", "open-source"]),
      published: true,
      order: 9,
    },
    {
      ...
      status: "Archived",
      role: "Solo",
      stack: JSON.stringify(["PHP", "MySQL", "jQuery"]),
      category: "University",
      tags: JSON.stringify(["university", "php"]),
      published: true,
      order: 10,
    },
  ];
  ...
  const articles = [
    {
      ...
      tags: JSON.stringify(["Sanity", "SEO", "CMS", "Migration"]),
      content: `
    ...
    },
    {
      ...
      readTime: "6 min read",
      category: "AI",
      tags: JSON.stringify(["AI", "LLM", "Function Calling"]),
    ...
    },
    {
      ...
      readTime: "7 min read",
      category: "Notes",
      tags: JSON.stringify(["Algorithms", "Career"]),
    ...
    },
    {
      ...
      readTime: "5 min read",
      category: "Engineering",
      tags: JSON.stringify(["Next.js", "Architecture"]),
    ...
    },
    {
      ...
      readTime: "4 min read",
      category: "Craft",
      tags: JSON.stringify(["Code Review", "Learning"]),
    ...
    },
    {
      ...
      readTime: "6 min read",
      category: "Engineering",
      tags: JSON.stringify(["Testing", "TDD"]),
    ...
    },
    {
      ...
      readTime: "4 min read",
      category: "Engineering",
      tags: JSON.stringify(["Testing", "Metrics"]),
    ...
    },
    {
      ...
      readTime: "5 min read",
      category: "Backend",
      tags: JSON.stringify(["Postgres", "Databases"]),
    ...
    },
    {
      ...
      readTime: "5 min read",
      category: "Career",
      tags: JSON.stringify(["Government", "Shipping"]),
    ...
    },
    {
      ...
      readTime: "4 min read",
      category: "Engineering",
      tags: JSON.stringify(["Monorepo", "Architecture"]),
    ...
    },
    {
      ...
      readTime: "5 min read",
      category: "Frontend",
      tags: JSON.stringify(["React", "State Management"]),
    ...
    },
    {
      ...
      readTime: "3 min read",
      category: "Notes",
      tags: JSON.stringify(["Writing", "Career"]),
